...
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-8 mx-auto">
        <div class="my-4">
            ...
            <p>Selecciona la notificación que quieres recibir</p>
            <hr class="my-4" />
            <strong class="mb-0">Seguridad</strong>
            <p>Alerta de control de seguridad que recibirá.</p>
            ...
            <p>Por favor, habilite la alerta del sistema que recibirá.</p>
            <div class="list-group mb-5 shadow">
                <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            <strong class="mb-0">Notifíqueme sobre nuevas funciones y actualizaciones</strong>
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            <strong class="mb-0">Notifíqueme por correo electrónico para las últimas noticias</strong>
